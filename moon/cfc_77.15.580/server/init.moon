...
netShouldBan = CreateConVar "#{prefix}_net_should_ban", 0, protected, "Whether or not to ban a client for triggering extreme net spam thresholds", 0, 1
...
commandShouldBan = CreateConVar "#{prefix}_command_should_ban", 0, protected, "Whether or not to ban a client for triggering extreme command spam thresholds", 0, 1
